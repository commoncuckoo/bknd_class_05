package kr.ac.cu.dgict.bknd_class_05.Controller;
...
import kr.ac.cu.dgict.bknd_class_05.Service.BlogPostService;
...
public class BlogPostController {
    ...
    public String post(Model model, @PathVariable("postid") Long postid){
        BlogPost article = service.findById(postid);
    ...
    public Long addPost(Model model, @RequestBody BlogPost entity){
        BlogPost saved = service.save(entity);
        return saved.getId();
    }
